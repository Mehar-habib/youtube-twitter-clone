...
function Sidebar() {
  return (
    <>
      <div className="sm:block hidden sm:w-44 md:w-56 w-16 sm:p-3 p-2 border-slate-600 space-y-32 xl:space-y-60 border-r h-[93vh]">
      ...
      <div className="border-t-2 h-16 sm:hidden p-1 w-full flex justify-around fixed bottom-0 bg-[#0e0f0f]">
